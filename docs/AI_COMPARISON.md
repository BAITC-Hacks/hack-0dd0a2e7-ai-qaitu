...
В интерфейсе серверный ключ не отображается. Для разового переопределения доступны поле пароля и модель в **«Настройки ИИ-агента»**. Для основного сравнения внешние вызовы выполняются в режиме **«ИИ + локальное сравнение»** после явного запуска. Центральная кнопка **«Запустить контрольный пример»** всегда запускает локальный пример; кнопка **«Запустить контрольный пример»** в боковой панели следует выбранному режиму. У модуля метрик есть отдельные ИИ-действия, которые используют серверные настройки; переопределение ключа и модели в боковой панели основного сравнения на них не распространяется.

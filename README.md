...
Матрица показывает по 10 строк на странице. Кнопка **«Развернуть»** открывает большое окно с теми же фильтрами и отдельными страницами по 25 строк; после закрытия можно продолжить работу с отчётом.
...
Проверка объединённой версии с `main` (`8650bd2`) — **23 сентября 2026 года**. Внешние ИИ-вызовы в автоматических тестах заменены тестовыми ответами:

...
3. Начните с первой вкладки **«Заключение»**: на экране кратко показаны охват, индикаторы рисков и изменения структуры. Полный Markdown-отчёт и JSON скачиваются отдельно; выводить весь каталог цитат на защите не требуется.
4. Затем откройте **«Структура»** и **«Матрица функций»**. В одной строке матрицы собраны соответствующие назначения функции, в колонках — подразделения до и после. Отфильтруйте строки по виду нормы, статусу или тексту, выберите строку и проверьте цитаты обеих версий. Во вкладке **«Источники и охват»** доступен поиск по всему каталогу.

...
отчёта, с текущими фильтрами и отдельными страницами по 10 строк. Все строки текущей
страницы и обе группы столбцов автоматически вписываются в размер окна без прокрутки
по горизонтали и вертикали, в том числе при изменении ширины панели. Escape, крестик
...
Локальный `matrix-fit.html` подбирает масштаб развёрнутой таблицы по свободной высоте
и ширине окна. `theme-bridge.html` передаёт палитру в нативные всплывающие окна Streamlit;

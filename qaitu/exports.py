...
from .reporting import COVERAGE_LABELS, FINDING_LABELS, NORM_LABELS, ROLE_LABELS, STATUS_LABELS, collect_sources
...
SHEET_NAMES = ("Сводка", "Изменения структуры", "Риски", "Матрица функций", "Потери", "Переданные функции", "Новые функции", "Источники")
